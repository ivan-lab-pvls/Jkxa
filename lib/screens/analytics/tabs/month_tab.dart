...
import 'package:smartspend_app/screens/analytics/charts_widget/month_bar_widget.dart';
          ...
          builder: (context, state) {
            if (state is LoadedMonthAnalyticsState) {
              return Padding(
                ...
                child: Column(
                  children: [
                    AppContainer(child: MonthChartWidget(monthData: state.monthAnalytics, maxAmount: state.maxIncome)),
                    SizedBox(height: 25),
                    AppContainer(
                      child: Column(
                        children: [
